...
# this includes the ecs + ALB modeules demo
# Also the extra add aws eks subsystem for kubernetes in AWS and a demo
...
modules | This includes the ecs + ALB modeules demo 
module-demo | modeule demo
eks-demo | Also the extra add aws eks subsystem for kubernetes in AWS and a demo whish only works in us-east1
